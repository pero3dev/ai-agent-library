...
| 5 | マルチモーダルモデルの**内部**(視覚エンコーダ・音声トークン化・拡散モデルの位置)が未カバー | [llm-internals.md](llm-internals.md)(テキスト系のみ) |
...
フェーズ記号は **AQ・AR** を使います(AO・AP は [org-process.md](org-process.md) が使用)。
