...
本書は 2026-09-10 に採択・導入した構成の記録です。導入後の拡張と実行面ごとの受入は [ハーネス実施記録](../../records/2026-09-10/harness-acceptance.md)、継続する操作は [現行運用](../../../freshness-automation.md) を参照してください。

## 採用した構成

ユーザーの指定により、**ChatGPT 契約内の Codex 定期タスク + GitHub Actions** で構築します。実装・登録内容・復旧手順の正本は [運用手順](../../../freshness-automation.md)、実測結果と残件は [導入記録](../../records/2026-09-10/freshness-automation-setup.md)です。
