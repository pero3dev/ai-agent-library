...
- **方針**: [coding-agents.md](../../project/plans/content/coding-agents.md) §7 の情報源優先順位に従い、公式サイト・公式ドキュメント・公式リポジトリ(GitHub API メタデータ含む)のみを根拠とする。確度は「公式明記 / 公式から推測 / 第三者」の 3 区分。未確認事項は「未確認」と明記
