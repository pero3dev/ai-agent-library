...
[レビュー報告書](../review-2026-09-10.md)の S02 のうち、参考資料に外部 URL のなかった 29 記事を対象に、本文の実証・安全性・心理特性・仕様に関する主張を読み直しました。一次資料を実際に開き、記事が使う範囲を資料の確認範囲に合わせています。参考資料に置かれていた執筆テンプレートは内容の根拠に使わず、該当 13 記事すべてで置き換えました。本文で自リポジトリの工程例を説明することは維持しています。
