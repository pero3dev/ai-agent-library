...
修正版のPR #58はmain CI・Pages・公開58/58・独立公開画像レビューまで受入完了した。6記事の現行公開ゲートとPR #58固定snapshotを保存した。詳細と別PCから辿れる証拠は[推論ラベルの公開受入記録](inference-score-label-fix.md#修正版の公開受入)を参照する。
