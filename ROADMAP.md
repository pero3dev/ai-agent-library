...
- **規制動向** — 起点: `research/professional/compliance.md`。次の確認: 令和 8 年法律第 56 号の主な施行政令、PPC 2026-09-16 の基本的な考え方①の後続議論と正式パブコメ、EU AI Act の高リスク義務・整合規格・既存システムのマーキング猶予、California の主体別 2026/2027 年適用、FTC 政策声明案の最終化と商務省州法リスト、Colorado と DOJ 訴訟
