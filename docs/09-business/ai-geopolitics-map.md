...
**本記事は鮮度リスクの高いページです。** 規則の版・対象品目リスト・掲載団体・対象国は月〜年単位で変わるため、参照の際は必ず本文冒頭の最終確認日と各当局の公式ページで現行版を確認してください。法令番号や更新例は確認先を特定するために示し、個別取引の適用判断には使いません。
...
> **最終確認日:** 2026-09-10 — 本記事が挙げる当局・公式ソースの所在はこの日付時点のものです。各 URL・確認状況の詳細は、リポジトリ内 `research/strategy/geopolitics.md` の調査メモを参照してください(主要な一次情報の入口は本記事末尾の参考資料にも掲載)。規則の内容・版・対象は必ず各公式ページで現物確認してください。

2026-09-21 の部分確認では、EU の輸出管理リストの 2026 年更新発表を反映しました。全当局・全規則を同日に再確認したものではありません。
...
2026-09-10 に確認した更新例では、BIS の 2026-07-10 発表は UAE の国群変更と、政府・承認済み企業に対する条件付き優遇を説明しています。UAE 向けの全取引が免許不要になったとは読めません。また 2026-05-31 の BIS ガイダンスは、相手方または最終親会社の本社が D:5 / Macau にある先端計算品目の取引では、第三国所在でも許可要件が続く場合を説明しています。**国名だけで判断せず、品目分類(ECCN)、用途、取引条件、相手方と最終親会社の本社所在地**を揃えて相談します。AI Diffusion の非執行方針と、既存のエンドユーザー管理は別に確認します。

EU の公式入口は Annex I 改正として委任規則 (EU) 2025/2003 を案内しています(採択 2025-09-08、公布 2025-11-14、発効 2025-11-15)。参考 Excel の更新年ではなく、官報の法令本文と発効条項を正本にします。

EU では、欧州委員会が **2026-09-14 に Annex I の 2026 年更新を採択**したと発表しました。先端計算向け集積回路(IC)や半導体製造・検査装置等を含む更新です。同発表は、理事会・欧州議会の通常 2 か月の審査期間を経た官報掲載により発効すると説明しています。採択発表だけで発効済みとは判断せず、既存の委任規則 (EU) 2025/2003 と、2026 年更新の官報・発効条項を区別して確認します。
...
| 欧州委員会 データ保護 / 十分性認定(EU) | GDPR に基づく第三国へのデータ移転と、十分性認定の決定・既存決定の再審査 |
| CAC(中国、PIPL 所管当局) | 個人情報保護法(PIPL)・データ安全法に基づく越境移転。公式専用索引の安全評価・標準契約・認証資料を確認 |
| MeitY(インド、DPDP 法) | Digital Personal Data Protection Act と関連規則を所管する省庁のデータ保護の入口 |

当局の更新は、決定の種類と施行段階を分けて記録します。EC 一覧のブラジルに対する 2026-01-26 の十分性認定決定と、韓国に対する 2026-07-23 の初回再審査は異なるイベントです。CAC の専用索引では 2025-06-27 掲載の安全評価申告ガイド第三版、2026-08-12 の個人情報保護 FAQ を確認できます。資料への到達確認と、自社に適用される条項の解釈は別です。

インド DPDP Rules 2025 の最終官報 G.S.R. 846(E) は取得可能です。Rule 1 は Rules 1・2・17〜21 を公布時、Rule 4 を公布 1 年後、Rules 3・5〜16・22・23 を公布 18 か月後としています。通知文書日は 2025-11-13、PIB の解説では通知日を 2025-11-14 と表記しているため、日単位の期限は公布日の扱いとともに専門部門で照合します。発表を全条文の即日施行と読み替えません。
...
3. **取引先リスト**: スクリーニング対象になる顧客・ベンダー・エンドユーザーの一覧。直接相手方と最終親会社の本社所在地、所有関係、対象品目・用途を含めます
...
- [Adequacy decisions(European Commission)](https://commission.europa.eu/law/law-topic/data-protection/international-dimension-data-protection/adequacy-decisions_en) — GDPR の第三国移転・十分性認定決定と再審査(EU)(アクセス日: 2026-09-10)
...
- [BIS — News and Updates](https://www.bis.gov/news-updates) / [2026-05-31 ガイダンス](https://media.bis.gov/media/documents/bis-guidance-may-31-2026.pdf) — UAE 発表と最終親会社の所在地に関する確認先(アクセス日: 2026-09-10)
- [委任規則 (EU) 2025/2003](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=OJ:L_202502003) — Annex I の改正と発効条項(アクセス日: 2026-09-10)
- [欧州委員会 — 2026 Update of the EU Control List of Dual-Use Items](https://policy.trade.ec.europa.eu/news/2026-update-eu-control-list-dual-use-items-2026-09-14_en) — 2026-09-14 の採択発表。審査期間・官報掲載・発効を別に確認(アクセス日: 2026-09-21)
- [CAC 越境データ専用索引](https://www.cac.gov.cn/wxzw/sjzl/sjcjaqpg/A09370801index_1.htm) / [個人情報保護 FAQ](https://www.cac.gov.cn/2026-08/12/c_1788195297373459.htm) — 安全評価・標準契約・認証の入口(アクセス日: 2026-09-10)
- [MeitY — DPDP Rules 最終官報](https://www.meity.gov.in/static/uploads/2025/11/53450e6e5dc0bfa85ebd78686cadad39.pdf) / [PIB 解説](https://www.pib.gov.in/PressNoteDetails.aspx?ModuleId=3&NoteId=156054&lang=1&reg=3) — Rule 1 の段階施行(アクセス日: 2026-09-10)
...
> **TODO(要確認):** 輸出管理規則・制裁/エンドユーザーリスト・データ規制はいずれも改定が速い。本文の更新例だけでは自社への適用を判断できない。参照時に各当局の公式ページ・官報で現行版・対象を現物確認する(所在は `research/strategy/geopolitics.md`)(最終確認: 2026-07)

> **TODO(要確認):** CAC の索引・FAQ への到達は確認済み。安全評価・標準契約・認証のどの経路が自社に該当するかは、索引の個別規定と現地法務・専門家で確認する。全規則の条項横断レビューは未実施(最終確認: 2026-09)

### 変わりやすい項目(定点観測)

> **TODO(要確認):** 本記事の全表(所管当局・公式ソース)のリンク生存と、各規則・リストの現行版を四半期ごとに確認する(`research/strategy/geopolitics.md` を更新起点にする)。直近の注目: BIS の UAE 発表に対応する官報 2026-14132 の発効日(本文未取得)、先端計算品目と最終親会社の条件、各制裁リスト、EU Annex I の 2026-09-14 採択分の官報掲載・発効、DPDP の段階施行の日単位の適用日を確認する(最終確認: 2026-09)
