...
動的図解は今回P1の全15記事の公開受入で停止し、P2以降は別セッションで続行する。[別PC向けの引き継ぎ入口](records/2026-09-24/dynamic-diagram-handoff.md)は作成中で、最終停止時に公開版と再開手順を確定する。

| 計画 | 状態・適用時点 | 実施記録・現行の入口 |
| --- | --- | --- |
| [動的図解の全記事展開](plans/engineering/dynamic-diagrams.md) | 2026-09-24 v1採択、P0・P1の6記事が公開受入完了（6/199記事）、C1学習パイプラインを制作中 | [展開状況](records/2026-09-24/dynamic-diagram-rollout.md)、[P0実施記録](records/2026-09-24/reading-diagram-foundation.md)、[Transformer制作](records/2026-09-24/transformer-reading-diagrams.md)、[注意変種制作](records/2026-09-24/attention-variants-reading-diagrams.md)、[MoE制作](records/2026-09-24/moe-reading-diagrams.md)、[文章生成・トークン化](records/2026-09-24/generation-tokenization-reading-diagrams.md)、[推論内部](records/2026-09-24/inference-reading-diagrams.md)、[学習パイプラインの制作](records/2026-09-24/training-reading-diagrams.md)、[記事別棚卸し](plans/engineering/dynamic-diagram-inventory.md)、[計画作成記録](records/2026-09-24/dynamic-diagram-plan.md) |
