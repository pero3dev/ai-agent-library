...
**進捗の読み方(2026-09-10):** 8 月の M1〜M3 に続き、9 月に全 16 系統を一次資料で再観測しました。[鮮度監査](freshness-audit-2026-09-10.md)で特定した 107 件について、本文・調査メモ・依存設定へ反映し、M4〜M5 と M6 の先端応用観測も実施しました。実装と検証の確定結果は[更新記録](freshness-update-2026-09-10.md)を参照してください。公開の成否は、この変更を取り込む PR と main の CI・Pages デプロイ結果を正本とします。
...
検証数・残す確認事項は[更新記録](freshness-update-2026-09-10.md)に集約します。旧条件「7 月残が実装選定時確認型のみ」は取り下げました。これは未観測項目の形式的な再分類ではなく、観測範囲と検証限界を明示するための変更です。
...
| M4 | 完了 | 2026-09-10 | 業界規制・来歴・フロンティア安全・知財・規格認証の 19 件を反映。[更新記録](freshness-update-2026-09-10.md)で検証・公開を追跡 |
| M5 | 完了 | 2026-09-10 | 輸出規制・環境開示・RPA・フィジカル AI の 24 件を反映。先端応用 8 件は M6 と同期 |
| M6 | 内容・検証完了 | 2026-09-10 | 先端応用 8 件、全 6 サンプルと SDK v2 移行、TODO・用語集・ROADMAP 同期を実施。サイト検証と公開結果は[更新記録](freshness-update-2026-09-10.md)と PR / main CI を参照 |
