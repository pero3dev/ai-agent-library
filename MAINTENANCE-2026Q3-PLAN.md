...
**進捗の読み方(2026-09-10):** 以下の冒頭数値・期日は 2026-08-18 に立てた計画の履歴です。M1〜M3 は実施済み、M4〜M5 と M6 の先端応用観測は未実施です。9 月のレビュー修正・サンプル検査・TODO 棚卸しは別記録であり、全 16 系統の最新化完了を意味しません。本文の更新日だけを根拠に、外部仕様の確認月を進めないようにします。

9 月の[TODO 棚卸し](research/review-maintenance-2026-09-10.md)は186件・121記事の分類・確認条件の追跡を完了しました。M6 の「7 月残が実装選定時確認型のみ」という完了条件は未達です。未実施観測・継続仕様確認・研究確認・要振り分けを、採用時確認へ形式的に変更して完了扱いにはしません。
...
| M4 | 未着手 | — | — |
| M5 | 未着手 | — | — |
| M6 | 一部実施 | 2026-09-10 | サンプルのモック・SDK/stdio・回帰検査と [TODO 186 件の分類・確認条件の追跡](research/review-maintenance-2026-09-10.md)を実施。先端応用の定点観測と外部仕様の全件再確認は未完了。修正結果は [修正記録](review-remediation-2026-09-10.md) を参照 |
