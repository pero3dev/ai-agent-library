...
- [要件定義・設計工程での活用](../08-coding-agents/se-requirements-and-design.md) — 確定した要件を、コーディングエージェントで設計工程に落とす SE 実践側
- [ドメイン別エージェント設計(13 章)](../13-domain-agents/README.md) — 「向き不向き」の判断を、リサーチ・データ分析・RPA などドメインごとに具体化した設計ガイド
