...
ローカルの全体検証は `npm ci`、`npm run check` 357試験、Windows 対象138試験、オフライン評価295試験が成功し、skip は0でした。
runtime の最終3 suite は88試験、CI/policy の関連 suite と追加の workflow 契約試験も成功しています。
