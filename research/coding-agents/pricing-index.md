...
| OpenAI Codex | ChatGPT Free / Go / Plus / Pro(5x・20x)/ Business / Edu / Enterprise + API キー従量 | 5 時間ウィンドウあたりメッセージ数(プラン・モデル依存)。超過はクレジット | <https://learn.chatgpt.com/docs/pricing>(旧 developers.openai.com/codex/pricing は 308 リダイレクト。2026-08-18 確認) |
...
- 2026-08-18 確認: GitHub Copilot の AI Credits 付与量は 2026-07 の記録値から変動なし(詳細は [github-copilot-practice.md](github-copilot-practice.md) §2.3)。Claude Code は Team の standard / premium 両シートとも Claude Code を含むことを確認([claude-code.md](claude-code.md) 参照)。Cursor はグローバルのプラン構成不変(インド限定 Cursor Start ₹649/月が 2026-07-28 新設。[cursor.md](cursor.md) 参照)
