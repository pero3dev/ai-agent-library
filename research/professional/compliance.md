...
**2026 年 7 月当時の小括(履歴)**: 記事で EU を紹介する際は「禁止・GPAI 義務は適用済み / 透明性義務は 2026-08-02 から / 高リスク義務は omnibus で 2027-12-02・2028-08-02 に延期済み(成立済み・公布待ち)」という 3 層の時間軸を用いていました。その後の公布・発効と正確な期限は上の更新行を参照してください。2026-09-21 の部分確認でも Regulation (EU) 2026/1744 の改正後期限は一致しました。
...
1. **EU omnibus は公布・発効済み**: Regulation (EU) 2026/1744 として官報公布(公布日 2026-07-24 は二次 + EUR-Lex ELI URL の存在で確認)・**2026-07-27 発効**(欧州委員会公式ページで規則番号・発効日を一次確認)。高リスク新期日 2027-12-02 / 2028-08-02 も公式ページで再確認。EUR-Lex 本文は bot 遮断で直接取得不可(digital-strategy.ec.europa.eu で代替裏取り)
2. **透明性義務(Art. 50)は 2026-08-02 に適用開始済み**(公式 Quick Facts)。**Art. 50 ガイドラインを 2026-07-20 に採択**、**Code of Practice on Transparency of AI-generated Content 最終版は 2026-06-10 公表**(委員会と AI Board が「適切な自主的ツール」と確認)。マーキング猶予の正確な範囲は「**2026-08-02 より前に市場投入済みの生成 AI システムに限り 2026 年 12 月まで**」(公式は月単位。「2026-12-02」の日付単位は二次のみ)— 前節 2 の「実装猶予 2026-12-02」は範囲限定を追記して補正
3. **日本の改正個情法は成立 2026-07-10・公布 2026-07-17**(PPC 公式プレス + 特設ページ)。施行は「一部を除き公布から 2 年以内の政令指定日」で未確定。「円滑な施行に向けたロードマップ」2026-07-31 決定。法律番号は PPC ページからは未確認 → TODO 継続
4. **California AI Transparency Act(SB 942 系・AB 853 改正後)は 2026-08-02 に operative**(BPC §22757.6 を州法典で一次確認)。段階適用: 大規模オンラインプラットフォーム 2027-01-01・キャプチャデバイス 2028-01-01。再延期の改正なし
5. **Colorado**: SB 26-189 の 2027-01-01 適用に変更なし。**DOJ が xAI の Colorado AI 法違憲訴訟に介入**(justice.gov プレスで一次確認。介入申立 2026-04-24・執行一時停止合意 2026-04-27 は二次情報)
...
PPC の工程と EU 改正後期限に限定しました。米国・ベンダー規約・規格・法的適用判断は対象外です。PPC の掲載ページ(2026-09-20T22:27:44Z)と 9/16 資料(22:27:52Z)、9/9 工程表(22:28:00Z)を取得し、議論実績を本文へ反映しました。時刻の日付はいずれも UTC の 2026-09-20 です。

EU 改正 https://eur-lex.europa.eu/legal-content/EN/ALL/?uri=CELEX%3A32026R1744 (2026-09-20T22:27:52Z)は発効日と Article 113 / 111(4) の期限が既存記事と一致しました。PPC の公布発表 https://www.ppc.go.jp/news/press/2026/260717/ (22:28:36Z)も成立・公布日と一致しました。

改正法 PDF は取得できましたが、e-Gov 将来施行版は本文を抽出できず、主な政令指定日の確定状況と一部罰則の絶対日付の直接再確認は未了です。9 月 10 日の記録を今日の確認済みに置き換えません。取得: 2026-09-20T22:28:00Z(PDF)、22:28:09Z(e-Gov)。URL・分類の機械可読記録は freshness-runs/20260920t222658728z-922c2745.json にあります。
