...
2026-09-10 の[鮮度監査](freshness-audit-2026-09-10.md)で洗い出した **107 件(訂正 56 件・補足 51 件)をすべて反映**しました。本文 49 記事、関連調査メモ、用語集、全 16 系統の観測予定、Python サンプルと CI / サイト依存を同期しています。記事は既存の published ステータスを維持しました。
