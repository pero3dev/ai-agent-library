...
> **最終確認日: 2026-09-10。** 知財本部のプリンシプル・コード公開と届出開始予定を再確認しました。他の資料の確認日は各参考資料・調査メモを参照してください。**著作権・知財の公的資料と法制度は改定・審議が速い**ため、参照時は必ず各発行主体の公式ページで現行版を確認してください。各資料の URL・確認状況はリポジトリ内 `research/trust/copyright.md` の調査メモに整理しています(主要な一次情報は末尾の参考資料にも掲載)。
...
| 知財保護・透明性の開示 | 「生成 AI の適切な利活用等に向けた知的財産の保護及び透明性に関するプリンシプル・コード」(正式資料公開済み、2026-09-10 確認) | コード本文・開示事項の具体例・届出様式を確認し、自社や提供者の開示内容を検討するとき |
...
知財本部の専用ページにはコードの日本語版・英語仮訳、開示対象事項の具体例、届出様式が公開されています。**届出は 2026-10-26 開始予定**で、2026-09-10 時点では未開始です。資料の公開と届出受付を分けて追跡します。正式な採択日・公開日は専用ページから特定できないため、第 13 回検討会の 2026-08-18 と同一視しません。
...
| 内閣府・内閣官房 知的財産戦略推進事務局 | ①〜③横断 + 契約・技術対応(内閣官房の検討会ページとプリンシプル・コード専用ページで資料・届出を確認) |
...
- [AI 時代の知的財産権検討会(内閣官房)](https://www.cas.go.jp/jp/seisakukaigi/titeki2/ai_kentoukai/kaisai/index.html) — 中間とりまとめ・権利者のための手引き等の検討会資料(アクセス日: 2026-09-10)
- [知的財産の保護及び透明性に関するプリンシプル・コード(内閣官房)](https://www.cas.go.jp/jp/seisakukaigi/titeki2/ai_principle_code/index.html) — 正式コード、具体例、様式と 2026-10-26 の届出開始予定(アクセス日: 2026-09-10)
...
> **TODO(要確認):** 本記事の資料名・版・発行主体を四半期ごとに各発行主体の公式ページで再確認する(`research/trust/copyright.md` を更新起点にする)。直近の注目: 文化庁のガイダンス追補、知財本部プリンシプル・コードの 2026-10-26 届出開始と運用、正式採択日・公開日の特定、特許庁の産構審での検討、米国著作権局 Part 3(学習)の最終版公表、EU GPAI 学習内容要約テンプレートの運用(最終確認: 2026-09)
