...
> **TODO(要確認):** 本記事の全表(所管当局・公式ソース)のリンク生存と、各規則・リストの現行版を四半期ごとに確認する(`research/strategy/geopolitics.md` を更新起点にする)。直近の注目: BIS の UAE 発表に対応する官報 2026-14132 の発効日(本文未取得)、先端計算品目と最終親会社の条件、各制裁リスト、EU Annex I の後続改正、DPDP の段階施行の日単位の適用日を確認する(最終確認: 2026-09)
