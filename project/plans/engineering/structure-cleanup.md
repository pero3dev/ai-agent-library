...
状態: S0〜S5完了(2026-09-11)。結果と保持対象は[実施記録](../../records/2026-09-11/structure-cleanup.md)を参照してください。以下の調査・提案は採択時点の記録です。
...
- Windows限定sandboxのGit所有権エラーは [既存の実施記録](../../records/2026-09-10/harness-acceptance.md) と区別します。別環境での成功により未成功条件を消しません。
