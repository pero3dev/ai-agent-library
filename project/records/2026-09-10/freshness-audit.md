...
本書は更新前に特定した候補と取得時点の記録です。適用結果と確認時の補正は [鮮度更新の実施記録](freshness-update.md) を参照してください。監査 JSON の当時の判定は上書きしません。

> **実装後の記録:** 本書は監査時点のスナップショットです。107 件の反映結果と検証は[鮮度更新の実施記録](freshness-update.md)を参照してください。
